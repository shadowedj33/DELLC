    ...
    <Section id="benefits">
      <div className="container -top-[-10rem] items-center relative z-2 pt-[16rem]">
        ...
        <div className="flex flex-wrap gap-10 mb-10">
          {benefits.map((item) => (
            <div
              className="block overflow-hidden relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem] rounded-[25%]"
              style={{
            ...
            >
              ...
              <div
                className="absolute inset-0.5 bg-n-8 rounded-[25%]"
